...
<section class="quick-select">
   ...
   <h1 class="heading">Quick Navigation</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="likes.php" class="inline-btn"><i class="fas fa-thumbs-up"></i> View Likes</a>
         <p>Total comments : <span><?= $total_comments; ?></span></p>
         <a href="comments.php" class="inline-btn"><i class="fas fa-message"></i> View Comments</a>
         <p>Saved playlist : <span><?= $total_bookmarked; ?></span></p>
         <a href="bookmark.php" class="inline-btn"><i class="fas fa-bookmark"></i> View Bookmark</a>
      </div>
      <?php
         }else{ 
      ?>
      ...
      <div class="box">
         <h3 class="title">HR Categories</h3>
         <div class="flex">
            <a href="#"><i class="fas fa-users"></i><span>Human Resource</span></a>
            <a href="#"><i class="fas fa-computer"></i><span>Information Technology</span></a>
            <a href="#"><i class="fas fa-chart-simple"></i><span>Business</span></a>
            <a href="#"><i class="fas fa-pen"></i><span>Design</span></a>
            <a href="#"><i class="fas fa-book"></i><span> Law</span></a>
            <a href="#"><i class="fas fa-calculator"></i><span>Accounting</span></a>
            <a href="#"><i class="fas fa-chart-line"></i><span>Marketing</span></a>
            <a href="#"><i class="fas fa-code"></i><span>IT Solutions</span></a>
         </div>
      </div>

      <div class="box">
         <h3 class="title">HR Topics</h3>
         <div class="flex">
            <a href="#"><i class="fab fa-readme"></i><span>Philippine Laws</span></a>
            <a href="#"><i class="fas fa-folder"></i><span>Labor Codes</span></a>
            <a href="#"><i class="fab fa-laravel"></i><span>HR Solutions</span></a>
            <a href="#"><i class="fab fa-creative-commons-by"></i><span>HR Management</span></a>
            <a href="#"><i class="fas fa-building"></i><span>Company Ethics</span></a>
            <a href="#"><i class="fas fa-sitemap"></i><span>Employee/Employer</span></a>
         </div>
      </div>

      <div class="box tutor">
         <h3 class="title">Become a Tutor</h3>
         <p>Be the next HR front in our nation and teach the people the essentialities of being an HR.</p>
         <a href="contact.php" class="inline-btn"><i class="fas fa-envelope"></i> Get started</a>
      </div>
...
<section class="courses">
   ...
   <div class="more-btn">
      <a href="about.php" class="inline-option-btn">View More</a>
   </div>
