...
<section class="about">
   ...
   <div class="row">
      ...
      <div class="image">
         <img src="images/faqs.svg" alt="">
      </div>

      <div class="content">
         <h3>What are the frequently asked question within the website?</h3>
         <p>There are many questions as to how to access the website or how to view such features within it. Hence, we provide to you the frequently asked questions within the system as well as their answers to fully acquaint you with your concerns.</p>
         <a href="#faq" class="inline-btn"><i class="fas fa-question-circle"></i> View FAQs</a>
      </div>
...
<section class="reviews">
   ...
   <h1 class="heading">Frequently Asked Questions</h1>
    ...
    <button class="accordion" id="faq">How to register an account in this website?</button>
    <div class="panel">
    <h2 style="text-align: justified;">Kindly click the user button on the top right area and click register. Also, you can click the register button in the homepage for easier accesibility.</h2>
    </div>

    <button class="accordion">Where do I send my payment?</button>
    <div class="panel">
    <h2 style="text-align: justified;">Once done registering, you will receive an email with the account numbers you will send your payment to depending on what payment method you want to pay with.</h2>
    </div>

    <button class="accordion">When can I have access to my account?</button>
    <div class="panel">
    <h2 style="text-align: justified;">As soon as you are done paying, the Administrator of the system will then configure your account for activation, then and only then you will have access to your account.</h2>
    </div>

    <button class="accordion">How will I be able to watch the modules inside the system?</button>
    <div class="panel">
    <h2 style="text-align: justified;">You will only be able to watch the modules within the website when your account gets activated by the Administrator, that is if you wish to pay to avail or re-avail your account </h2>
    </div>

    <button class="accordion">How will I be able to getthe Zoom Link for the upcoming Online events I have availed?</button>
    <div class="panel">
    <h2 style="text-align: justified;">The zoom credentials will be sent o your email once you have paid already and once the Administrator had configured your payment.</h2>
    </div>

    <button class="accordion">Will I get a certificate once I finish the Zoom Event or the Modules within the video?</button>
    <div class="panel">
    <h2 style="text-align: justified;">Definitely! You will acquire your certificate once finishing the stated progresses above.</h2>
    </div>

    <button class="accordion">How will I be able to re-activate my account to join another event?</button>
    <div class="panel">
    <h2 style="text-align: justified;">You will firstly have to visit the Registration page, once in the page, hover to the link below the form, there will be a link that will tell you to register a page with an inactive account. Once in the page, you will then fill up the re-registration form.</h2>
    </div>

    <button class="accordion">What shall I do whenever I forget my account password?</button>
    <div class="panel">
    <h2 style="text-align: justified;">Navigate through the login page. There will be a link within the page that says "Forgot password?", click the link to get in the first step of changing your password which is to enter your account email. Once entering, you will then receive a One Time Pin from the website that you shall enter to the form. Upon entering the correct pin, you will then be able to change your password freely.</h2>
    </div>
