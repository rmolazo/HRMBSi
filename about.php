...
<section class="about">
   ...
   <div class="row">
      ...
      <div class="content">
         <h3>What to learn within the Course</h3>
         <p>The course is composed of the current Attorney, Josephus B. Jimenez, and his discussion regarding the Labor Laws in the Philippines which states various problems and dilemmas the nation is having. Also, he has his conditions and movements to solve the said issues that will rise the HR in the nation from the ground.</p>
         <a href="courses.php" class="inline-btn"><i class="fas fa-camera"></i> Our Courses</a>
      </div>
...
<section class="reviews">
   ...
   <h1 class="heading">Viewer Ratings</h1>

   <div class="box-container">

      <div class="box">
         <p>Every seminar is a must to attend as each day, they give various lessons and stuff to talk about, especially peronally and politically.</p>
         <div class="user">
            <img src="images/pic-2.jpg" alt="">
            <div>
               <h3>Angelica Bayron</h3>
               <div class="stars">
      ...
      <div class="box">
         <p>This helps viewers and other people be the best of themselves especially nowadays where people are always coping with hope but dealing with weakness.</p>
         <div class="user">
            <img src="images/pic-3.jpg" alt="">
            <div>
               <h3>Daniel Celestial</h3>
               <div class="stars">
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
      ...
      <div class="box">
         <p>Hands down one of the best speakers out there. Always in par with the discussions and his explanation, as well as his drive and will to discuss each part of the lesson.</p>
         <div class="user">
      ...
      <div class="box">
         <p>One of the most essential seminars out there that teaches both personal and work-related values. Easily a high rating.</p>
         <div class="user">
            <img src="images/pic-5.jpg" alt="">
            <div>
               <h3>Joanna Padawang</h3>
               <div class="stars">
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
      ...
      <div class="box">
         <p>Given the whole package of teaching, I have learned tons from the seminar itself as everything was lawful and justifiable</p>
         <div class="user">
            <img src="images/pic-6.jpg" alt="">
            <div>
               <h3>Yanver Abrenica</h3>
               <div class="stars">
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
      ...
      <div class="box">
         <p>It was great being a co-viewer along with the others as we had a very good time socializing while listening to each other.</p>
         <div class="user">
            <img src="images/pic-7.jpg" alt="">
            <div>
               <h3>Cristina Osorio</h3>
               <div class="stars">
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
