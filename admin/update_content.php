...
if(isset($_POST['update'])){
   ...
   $update_content = $conn->prepare("UPDATE `content` SET title = ?, description = ?, link = ?, status = ? WHERE id = ?");
   $update_content->execute([$title, $description, $link, $status, $video_id]);
...
<head>
   ...
   <title>HRMBSi | Update Content</title>
...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required class="box" value="<?= $fecth_videos['title']; ?>">
      <p>Update Description <span>*</span></p>
      <textarea name="description" class="box" required maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>Update Link <span>*</span></p>
      <input type="text" name="link" maxlength="100" required class="box" value="<?= $fecth_videos['link']; ?>">
      <p>Update Playlist</p>
      ...
      <video src="../uploaded_files/<?= $fecth_videos['video']; ?>" controls hidden></video>
      <p hidden>Update Video</p>
      <input type="file" name="video" accept="video/*" class="box" hidden>
      <input type="submit" value="Update content" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn"><i class="fas fa-eye"></i> View content</a>
