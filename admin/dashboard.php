...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Total Contents</p>
         <a href="add_content.php" class="btn"><i class="fas fa-plus"></i> Add New Content</a>
      </div>

      <div class="box">
         <h3><?= $total_playlists; ?></h3>
         <p>Total Playlists</p>
         <a href="add_playlist.php" class="btn"><i class="fas fa-plus"></i> Add New Playlist</a>
      </div>
      ...
      <div class="box">
         <h3><?= $total_users; ?></h3>
         <p>Total Users</p>
         <a href="users.php" class="btn"><i class="fas fa-eye"></i> View Users</a>
      </div>
