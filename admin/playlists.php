...
<section class="playlists">
   ...
   <div class="box-container">
      ...
      <div class="box" style="text-align: center;">
         ...
         <a href="add_playlist.php" class="btn"><i class="fas fa-plus"></i> Add Playlist</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn"><i class="fas fa-pen"></i> Update</a>
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Delete this playlist?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn"><i class="fas fa-eye"></i> View playlist</a>
      </div>
      <?php
         } 
      }else{
