   ...
   <div class="details">
      ...
      <div class="flex">
         <div class="box">
            ...
            <p>Total Playlists</p>
            <a href="playlists.php" class="btn"><i class="fas fa-eye"></i> View Playlists</a>
         </div>
         <div class="box">
            <span><?= $total_contents; ?></span>
            <p>Total Videos</p>
            <a href="contents.php" class="btn"><i class="fas fa-eye"></i> View Contents</a>
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <p>Total Comments</p>
            <a href="comments.php" class="btn"><i class="fas fa-eye"></i> View Comments</a>
         </div>
      </div>
   </div>
   ...
   <div class="details">
      ...
      <div class="box-container">
         <div class="flex">
            <div class="box">
               <div class="flex">
                  <i class="fas fa-clock" style="font-size: 2rem;
                                                color: var(--black);
                                                border-radius: .5rem;
                                                height: 4.5rem;
                                                cursor: pointer;
                                                ...
                                                margin-left: .5rem;
                                                background-color: var(--black);
                                                color:var(--white);"></i><p style="font-size: 15px; color: gray;">Login Activity</p>
                  <div>
                  <p style="font-size: 15px; color: gray;">Logins: <?php echo $total_logins . ', ' . 'Last Login: ' . $lastlogin; ?></p>
                  </div>
               </div>
            </div>
         </div>
